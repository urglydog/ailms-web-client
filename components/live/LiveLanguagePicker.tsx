                  ...
                  return (
                    <li key={code}>
                      ...
                      >
                        ...
                        {!isSource && track && (
                          <span className="flex shrink-0 items-center gap-1 rounded-full bg-line-soft px-2 py-0.5 text-[11px] text-ink-muted">
                            <svg width="10" height="10" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M11 5 6 9H2v6h4l5 4z" /><path d="M15.5 8.5a5 5 0 0 1 0 7" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" /></svg>
