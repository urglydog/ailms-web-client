    ...
    <div className="flex flex-col items-center">
      ...
      >
        <div className={`w-full h-full transition-transform duration-500 transform-style-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
          ...
          {/* Front */}
          <div className="absolute inset-0 backface-hidden bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border-2 border-line-soft flex items-center justify-center p-8 group-hover:border-accent/30 transition-colors">
          ...
          {/* Back */}
          <div className="absolute inset-0 backface-hidden bg-accent text-white rounded-2xl shadow-lg flex items-center justify-center p-8 rotate-y-180">
