/** Icon dùng cho sidebar Giảng viên + trang "Công cụ" (19/09/2026, mở rộng — giao diện tham khảo
 * Udemy) — SVG line-icon đơn sắc, đơn giản (không hiệu ứng gradient/3D "trông như AI vẽ"), đổi
 * màu qua `currentColor` như `CurriculumIcons.tsx` đã dùng cho trình soạn Chương trình giảng dạy. */
...
export function TagIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12.6 2.6H2.6v10l10.5 10.5a2 2 0 0 0 2.8 0l7.5-7.5a2 2 0 0 0 0-2.8z" />
...
/** "Giao tiếp" (19/09/2026, tính năng mới) — Q&A/Tin nhắn/Bài tập/Thông báo. */
export function MessageCircleIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
/** Nút chuyển kiểu xem "2 cột"/"1 cột" (19/09/2026) — giao diện tham khảo Udemy Q&A. */
...
/** "Cài đặt" (19/09/2026) — nút bánh răng góc trên-phải trang chỉnh sửa khóa học. */
