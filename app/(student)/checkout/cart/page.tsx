    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="mx-auto max-w-4xl px-4 md:px-8">
        <div className="mb-8 flex items-center justify-between">
          <h1 className="font-display text-3xl font-bold text-gray-900">Thanh toán {items.length > 1 ? `${items.length} khóa học` : 'khóa học'}</h1>
          <button
          ...
          <div className="space-y-6 md:col-span-2">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="flex flex-col gap-4">
                {items.map((item) => (
                  <div key={item.courseId} className="flex flex-col gap-4 border-b border-gray-100 pb-4 last:border-0 last:pb-0 sm:flex-row">
                    ...
                    <div className="flex flex-1 flex-col justify-center">
                      <h3 className="font-display text-base font-bold text-gray-900">{item.courseTitle}</h3>
                      <p className="mt-1 text-sm text-gray-500">GV. {item.instructorName}</p>
                    </div>
                    <div className="flex shrink-0 items-center font-display text-base font-bold text-gray-900">
          ...
          <div className="space-y-6 md:col-span-1">
            <div className="sticky top-24 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="flex justify-between border-b border-gray-100 pb-4">
                <span className="text-gray-600">Tạm tính ({items.length} khóa học)</span>
